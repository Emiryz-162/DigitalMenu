    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "Id", "BackgroundImagePath", "RestaurantName", "UpdatedDate", "WelcomeText" },
                values: new object[] { 1, "/images/settings/default-bg.jpg", "Restoran Adı", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hoş Geldiniz" });
